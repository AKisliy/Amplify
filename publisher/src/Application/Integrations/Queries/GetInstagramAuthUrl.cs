...
public record GetInstagramAuthUrlQuery(Guid ProjectId) : IRequest<InstagramAuthUrl>;
    ...
    : IRequestHandler<GetInstagramAuthUrlQuery, InstagramAuthUrl>
{
    ...
    {
        return await instagramIntegrationService.GetAuthUrlAsync(request.ProjectId, cancellationToken);
    }
}
