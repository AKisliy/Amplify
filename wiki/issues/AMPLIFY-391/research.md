...
| [[concepts/template-naming-in-analytics]] | Проблема template names в userservice; варианты A/B/C; выбрана денормализация template_name в job_executions |
...
- Library templates: разрешать ли пользователю создавать шаблоны вне library? Ответ определяет, нужен ли `library_template_id` в аналитике наряду с `template_name`.
