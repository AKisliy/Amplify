...
namespace UserService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260404092606_AddTemplateIdToProjectAsset")]
    partial class AddTemplateIdToProjectAsset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserService.Domain.Entities.Ambassador", b =>
                {
                    ...
                    b.Property<string>("VoiceDescription")
                        .HasColumnType("text")
                        .HasColumnName("voice_description");
            ...
            modelBuilder.Entity("UserService.Domain.Entities.ProjectAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<AssetLifetime>("Lifetime")
                        .HasColumnType("userservice.asset_lifetime")
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_assets_project_id");

                    b.ToTable("project_assets", "userservice");
                });
            ...
            modelBuilder.Entity("UserService.Domain.Entities.ProjectAsset", b =>
                {
                    b.HasOne("UserService.Domain.Entities.Project", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_assets_projects_project_id");
                });
